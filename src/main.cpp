...
#define REWARD_CUT_BLOCK 40000001
...
uint256 hashGenesisBlock("0x00000716c5b2d8f396c1a07f71dee8bc19e32452579e5d31dce58a7d9e79081d");
...
// Launch specs
static const int64 nTargetTimespan =  2 * 60; // Ozcoin: Two hours
static const int64 nTargetSpacing = 1 * 60; // Ozcoin: 60 seconds
...
unsigned int static DarkGravityWave(const CBlockIndex* pindexLast, const CBlockHeader *pblock) {
    /* current difficulty formula, Ozcoin - DarkGravity, written by Evan Duffield - evan@Ozcoin.io */
    const CBlockIndex *BlockLastSolved = pindexLast;
    const CBlockIndex *BlockReading = pindexLast;
    const CBlockHeader *BlockCreating = pblock;
    BlockCreating = BlockCreating;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x000008c20f2cd2447d58178e22b4575a9f7f0c04d9b7d91af7d89d7ffc2246fc");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
      ...
      //vMerkleTree: 3f66108684400d84e2ffb528360d534fa19ecaf47c7c4c2ca1d1352ec4a351ad
        ...
        // Genesis block
        const char* pszTimestamp = "Moonday Morning: IMF builds its own cryptocurrency for learning and more";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1555346747;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 831362;

        if (fTestNet)
        {
            block.nTime    = 1555346767;
            block.nNonce   = 254751;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x83fba274f13774c215dd46b8b4e5977bfeea7bea1c123b805ad6bb98f6efa899"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xc5, 0xb7, 0xf1, 0xd6 }; 
